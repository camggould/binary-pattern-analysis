...
The difficulty with all of these ciphers is that decoding the data with the assumption that they encode ASCII, Latin1, or other common encodings (UTF-8, UTF-16), the outputs do not bear any ciphertext or plaintext. It is instead a series of symbols that are meaningless. This repository is being used as a way to exhaustively explore each cipher's data for patterns.